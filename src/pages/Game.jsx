...
export default function Game({ scroll }) {
  ...
  return (
    <main className="main-game">
      <div className="game">
        <div className={`game__main ${disabled ? 'game__main--cursor' : ''}`}>
          game
        <div className={`game__wacker ${clicked ? 'game__wacker--clicked' : ''} ${disabled ? 'game__wacker--disabled' : ''}`} ref={wackerRef}></div>
        </div>
